...
import TopSellingProductsWidget from './widgets/TopSellingProductsWidget';
import AccountsReceivableWidget from './widgets/AccountsReceivableWidget';
...
const WIDGETS: Record<string, React.FC<any>> = {
    ...
    accounts_receivable: AccountsReceivableWidget,
};
