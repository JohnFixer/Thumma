            ...
            <div className="flex-1 overflow-y-auto p-4">
                {filteredProducts.length > 0 ? (
                        ...
                        {filteredProducts.map(product => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="mt-2">
                                        <p className="font-semibold text-xs leading-tight h-8 overflow-hidden">{product.name[language]}</p>
                                        <div className="flex justify-between items-baseline mt-1">
                                            <p className="text-sm font-bold text-primary">
                                                {hasMultipleVariants && <span className="text-xs font-normal text-text-secondary">{t('price_from')} </span>}
                                        ...
                                        {hasMultipleVariants && (
                                            <p className="text-xs text-blue-600 font-semibold mt-1">{t('sizes_available_title', {count: product.variants.length})}</p>
                                        )}
                                    </div>
                                </button>
                            );
                    ...
                    <div className="text-center py-16 text-text-secondary">
                        ...
                        <p className="font-semibold mt-2">{t('no_products_found')}</p>
