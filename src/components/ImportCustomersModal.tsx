    ...
    reader.onload = (event) => {
      try {
        ...
        for (const [index, row] of jsonData.entries()) {
          ...
          const type = getValue(row, 'Type') ? String(getValue(row, 'Type')).toLowerCase() : null;
          ...
          customersToCreate.push({
            ...
            phone: getValue(row, 'Phone') ? String(getValue(row, 'Phone')) : undefined,
            address: getValue(row, 'Address') ? String(getValue(row, 'Address')) : undefined,
          });
        }
