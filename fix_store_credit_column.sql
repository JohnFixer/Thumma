-- Fix missing columns in store_credits table
ALTER TABLE store_credits 
ADD COLUMN IF NOT EXISTS original_transaction_id TEXT REFERENCES transactions(id);
...
-- Re-run the RPC creation just to be safe
