    ...
    reader.onload = (event) => {
      try {
        ...
        for (const [index, row] of jsonData.entries()) {
            ...
            const contactPerson = row['Contact Person'] ? String(row['Contact Person']) : null;
            ...
            suppliersToCreate.push({
                ...
                logo: row['Logo URL'] ? String(row['Logo URL']) : `https://picsum.photos/seed/${name.replace(/\s/g, '')}/100/100`,
            });
        }
