                    ...
                    <div>
                        ...
                        <div className="flex rounded-md shadow-sm">
                            ...
                            <button
                                ...
                                className={`px-2 py-2 text-xs font-medium border border-gray-300 flex-1 first:rounded-l-md last:rounded-r-md -ml-px ${
                                orderType === type ? 'bg-primary text-white z-10' : 'bg-white text-gray-700 hover:bg-gray-50'
                                }`}
                            >
...
// FIX: Add default export for the CartPanel component.
